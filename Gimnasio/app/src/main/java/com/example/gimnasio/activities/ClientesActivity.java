...
public class ClientesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (usuarioNick != null) {
            Toast.makeText(ClientesActivity.this, "Bienvenido, " + usuarioNick, Toast.LENGTH_SHORT).show();
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    ...
                    Toast.makeText(ClientesActivity.this, "Configuraciones seleccionadas", Toast.LENGTH_SHORT).show();
        ...
        builder.setMessage("¿Estás seguro que deseas salir de la aplicación?")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(ClientesActivity.this, "No se ha cerrado la app", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        builder.setMessage("¿Estás seguro que deseas cerrar sesión?")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(ClientesActivity.this, "No se ha cerrado sesión", Toast.LENGTH_SHORT).show();
                    }
                });
