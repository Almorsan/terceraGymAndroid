...
public class ActividadesActivityTres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actividades_tres);
        ...
        if (usuarioNick != null) {
            Toast.makeText(ActividadesActivityTres.this, "Bienvenido, " + usuarioNick, Toast.LENGTH_SHORT).show();
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    ...
                    Toast.makeText(ActividadesActivityTres.this, "Configuraciones seleccionadas", Toast.LENGTH_SHORT).show();
    ...
    private void salirDeLaApp() {
        AlertDialog.Builder builder = new AlertDialog.Builder(ActividadesActivityTres.this);
        builder.setMessage("¿Estás seguro que deseas salir de la aplicación?")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(ActividadesActivityTres.this, "No se ha cerrado la app", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void cerrarSesion() {
        ...
        builder.setMessage("¿Estás seguro que deseas cerrar sesión?")
                ...
                .setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(ActividadesActivityTres.this, ClientesActivity.MainActivity.class);
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(ActividadesActivityTres.this, "No se ha cerrado sesión", Toast.LENGTH_SHORT).show();
                    }
                });
